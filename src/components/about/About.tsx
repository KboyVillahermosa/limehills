...
export default function About() {
  return (
    <section id='about'>
    <div className="overflow-hidden bg-white dark:bg-gray-950 py-24 sm:py-32">
        ...
        <Reveal className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div className="lg:pt-4 lg:pr-8">
            <div className="lg:max-w-lg">
              <h2 className="text-base/7 font-semibold text-indigo-600 dark:text-indigo-300">Deploy faster</h2>
                ...
                {features.map((feature) => (
                  <div key={feature.name} className="relative pl-9">
                    <dt className="inline font-semibold text-gray-900 dark:text-gray-100">
                      <feature.icon aria-hidden="true" className="absolute top-1 left-1 size-5 text-indigo-600 dark:text-indigo-300" />
                      {feature.name}
                    </dt>{' '}
          ...
          <Reveal>
            <img
              ...
              src={AboutImage}
              height={1442}
              className="w-3xl max-w-none rounded-xl shadow-xl ring-1 ring-white/10 dark:ring-white/5 sm:w-228 md:-ml-4 lg:-ml-0"
            />
          </Reveal>
        </Reveal>
      </div>
