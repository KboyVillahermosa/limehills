  ...
  return (
    <section className="w-full bg-white">
      <div className="mx-auto max-w-6xl px-6 py-20 text-center">
        <p className="text-lg text-gray-500 mb-4">Managing</p>
        ...
        <div className="flex items-center justify-center gap-6">
          <div className="flex -space-x-3">
            <img src="/src/assets/logo-placeholder-1.png" alt="client logo 1" className="w-10 h-10 rounded-full object-cover border-2 border-white bg-gray-100" />
            <img src="/src/assets/logo-placeholder-2.png" alt="client logo 2" className="w-10 h-10 rounded-full object-cover border-2 border-white bg-gray-100" />
            <img src="/src/assets/logo-placeholder-3.png" alt="client logo 3" className="w-10 h-10 rounded-full object-cover border-2 border-white bg-gray-100" />
          </div>
          <div className="text-sm text-gray-500">Trusted by 1000+ clients</div>
        </div>
      </div>
    </section>
  )
